"""
Scraper for Mustakbil Nepal (mustakbil)
...
class MustakbilNepalScraper(BaseScraper):
    """Scraper for Mustakbil Nepal job website."""
    
    def __init__(self):
        super().__init__(
            website_name="mustakbil",
            base_url="https://np.mustakbil.com",
            delay=1.0
        )
        
        self.search_url = "https://np.mustakbil.com/jobs/nepal"
        self.selectors = {
